...
2. 2D Logical Plane (Custom Dimension)
...
3. Mapping Pixel Space to Logical Space
...
So, (799, 599) in pixel space maps to (2.0,  1.5) in the     `logical pl a ne.`
