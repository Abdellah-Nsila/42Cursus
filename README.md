...
| 02         | [Pipex](https://github.com/Abdellah-Nsila/42cursus/tree/master/Milestone%202/pipex)                     | C, UNIX                                    | A project that mimics Unix pipes to chain multiple commands together.                                   | 125%   |
...
| 03         | [Minishell](https://github.com/Minishell13/Minishell)             | C, UNIX                                    | A simple shell implementation that handles command parsing and execution.                              | 125%   |
| 04         | [Cub3D](https://github.com/Cub3D1337/Spacetoon)             | C, MinilibX                               | عبد الله باهاعبد الله باهاA “realistic” 3D graphical representation of the inside of a maze from a first-person perspective. You have to create this representation using the Ray-Casting principles mentioned earlier.| 125%   |
| 04         | [CPP-Modules (00-04)](https://github.com/Abdellah-Nsila/CPP-Modules)                                    | Cعبد الله باها++                                   |     C++ is a general-purpose programming language created by Bjarne Stroustrup as an ex- tension of the C programming language, or "C with Classes".                              | 100%   |
...
| 05         | [Inception](https://github.com/Abdellah-Nsila/Inception)             | Docker, VM, UNIX,                                     | This project consists of having you set up a small infrastructure composed of different services under specific rules                              | 125%   |
---
