...
| 03         | [Minishell](https://github.com/Minishell13)             | C, UNIX                                    | A simple shell implementation that handles command parsing and execution.                              | 125%   |
| 03         | [Cub3D](https://github.com/Cub3D1337/Spacetoon)             | C, MinilibX                               | A “realistic” 3D graphical representation of the inside of a maze from a first-person perspective. You have to create this representation using the Ray-Casting principles mentioned earlier.| 125%   |
| 04         | [CPP-Modules (00-04)](https://github.com/Abdellah-Nsila/CPP-Modules)                                    | C++                                   |     C++ is a general-purpose programming language created by Bjarne Stroustrup as an ex- tension of the C programming language, or "C with Classes".                              | 0%   |
---
